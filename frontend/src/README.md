> Current login rollout: see [Google sign-in setup](docs/GOOGLE_AUTH.md). The frontend now uses Google OAuth; older email/SMTP instructions are historical alternatives.
